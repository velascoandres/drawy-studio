        ...
        <section className="flex flex-row flex-wrap items-center justify-center gap-3">
          {
            FEATURES.map(({ icon, title, description }, index) => (
              ...
              <Card key={`feat-${index}`} className="relative backdrop-blur-sm bg-background/50 w-[350px] md:w-[300px] group rounded-lg transition ease-in hover:scale-105 border-border p-2 cursor-pointer hover:bg-gradient-to-br from-background to-indigo-950 hover:border-indigo-400">
