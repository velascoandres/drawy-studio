...
export const SpaceCard = ({
  ...
  return (
    <ContextMenu>
      <ContextMenuTrigger>
        <article  
          className="overflow-hidden w-full min-w-[15rem]  md:max-w-sm transition ease-in group relative select-none h-40 flex flex-col items-start gap-2 justify-start rounded-lg px-3 py-5 border-2 border-secondary hover:border-primary dark:border-secondary dark:hover:border-primary"
        ...
        >
          ...
          <p className="text-md break-words  whitespace-normal truncate overflow-ellipsis mb-1 w-full">
            {space.description}
          </p>
